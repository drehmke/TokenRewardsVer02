namespace TokenRewardsVer02.Controllers {
    ...
    export class AccountController {
        ...
        */
        ...
        constructor(private accountService: TokenRewardsVer02.Services.AccountService, private $location: ng.ILocationService) {
    ...
    angular.module('TokenRewardsVer02').controller('AccountController', AccountController);
